...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center" data-aos="zoom-out" data-aos-delay="2">
        ...
        <div class="contact-info d-flex align-items-center">
            <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">helpdesk@schoolhelp.org</a></i>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="" class="logo" data-aos="fade-left" data-aos-delay="2"><img src="img/schoolhelpicon.png" alt="schoolhelp" width="40"> SchoolHELP</a>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container col-lg-5">
            ...
            <h2 data-aos="zoom-in" data-aos-delay="2"><strong>Recovering Education 2021: </strong> Together, helping restore education from the COVID-19 Pandemic</h2>
            <div class="d-flex">
                <a href="#about" class="btn-get-started scrollto" data-aos="zoom-in" data-aos-delay="5"><i class='bx bx-caret-down-circle'></i> Get Started</a>
                <a href="{{ route('register') }}" class="btn-get-started scrollto" style="margin-left: 10px; background-color: gray" data-aos="zoom in" data-aos-delay="5"><i class="bi bi-person-circle"></i><span> Register as Volunteer</span></a>
            </div>
        </div>
    ...
    <main id="main">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="2">
                            ...
                            <p class="description">Supporting our children who need to catch up on Lost Learning due to COVID-19 Pandemic</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        ...
                        <p class="description">Allow school to request for help from the general public to support the priorities mission</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        ...
                        <p class="description">Allow volunteer the volunteer to view the aids needed and give the aids to the students</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="2">
                            ...
                            <p class="description">Supporting the world of education from lost-learning with the implementation of IT</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="about" class="about section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content d-flex flex-column justify-content-center p-4" data-aos="fade-up" data-aos-delay="2">
                    <h3 style="text-align: justify">Many children all over the world have been disadvantaged by the COVID pandemic in the last two years</h3>
                    <p style="text-align: justify">
                        Most schools are back on track throughout the world after being closed for years due to the historic COVID-19 outbreak,
                        but the educational system is currently in the midst of a recovery phase during which it is reviewing the harm done and learning from the experience.
                        More than 1.5 billion children and teenagers were impacted by the pandemic, the hardest hit affecting the most vulnerable students.
                        Even after the schools have reopened, there is a possibility that additional students would lose motivation to learn in areas where distance
                        learning has not been successful. It is essential that everyone act right away if we are going to stop a learning crisis from
                        becoming a generational disaster.
                    </p>
                    <p style="text-align: justify">
                        SchoolHELP is a system that has been proposed to allow schools to request for help from the general public. The schools may schedule tutorials
                        for students who need remedial education, or request for resources. Volunteers can then check SchoolHELP for requests and make an offer to volunteer
                        for any requests that they can fulfill, for example to help out in a tutorial or donate digital devices.
                        The school administrator will review the offers for their requests and then contact the volunteers themselves.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary" style="width: 100%"> View Request</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="2">
                    ...
                    <div class="col-lg-6 ">
                        <iframe class="mb-4 mb-lg-0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.1924038136344!2d115.22439021457107!3d-8.673244893768114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd240f24881c587%3A0xe8413f111e0aa096!2sInstitut%20Teknologi%20Dan%20Bisnis%20STIKOM%20BALI!5e0!3m2!1sen!2sid!4v1669356616066!5m2!1sen!2sid" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
                    </div>
